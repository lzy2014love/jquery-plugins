 ...
 * @Date: 2018-01-18 15:22:50 
 * @Last Modified by: https://github.com/lzy2014love
 * @Last Modified time: 2018-02-07 15:18:22
 */
'use strict';
(function (global, factory) {
  ...
  $.fn.fixTop = function (options) {
    return this.each(function () {
      var opts = $.extend({}, $.fn.fixTop.defaultOptions, options);
      var obj = $(this);
      var selfTop = 0;
      var selfLeft = 0;
      var toTop = 0;
      ...
      var position;
      var objWidth = 0;
      var placeholder = $('<div>'); // 创建一个jquery对象
      var optsTop = opts.distanceTop; // 定义到顶部的高度
      var endfix = 0; // 开始停止固定的位置
      ...
      function resetScroll() {
        ...
        var startBottom = $(opts.startBottom);
        var toBottom; // 停止滚动位置距离底部的高度
        var ScrollHeight; // 对象滚动的高度
        ...
        if (startTop[0]) {
          ...
          var startTopPos = startTopOffset.top;
          selfTop = startTopPos;
        }
        if (startBottom[0]) {
          var startBottomOffset = startBottom.offset();
          var startBottomPos = startBottomOffset.top;
          var startBottomHeight = startBottom.outerHeight();
